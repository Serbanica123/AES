...
set_property -dict { PACKAGE_PIN M15 IOSTANDARD LVCMOS33 } [get_ports { PWM_DIR }]; #IO_L23N_T3_35 Sch=led[1]
set_property -dict { PACKAGE_PIN G14 IOSTANDARD LVCMOS33 } [get_ports { PWM_ERROR }]; #IO_0_35 Sch=led[2]
